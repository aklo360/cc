...
export class FfmpegPipeline {
    ...
    start() {
        ...
        args.push(
        // Video encoding
        '-c:v', 'libx264', '-preset', 'ultrafast', '-tune', 'zerolatency', '-b:v', this.config.bitrate, '-maxrate', '3000k', '-bufsize', '6000k', '-pix_fmt', 'yuv420p', '-g', String(this.config.fps * 2), // Keyframe every 2 seconds
        // Audio encoding
